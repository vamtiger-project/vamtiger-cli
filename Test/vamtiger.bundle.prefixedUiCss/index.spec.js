...
describe(`vamtiger.bundle.prefixedUiCss should`, function () {
    it('bundle the css for a defined input path', function (done) {
        ...
        vamtiger.get.readStream(uiPath)
            .pipe(vamtiger.bundle.prefixedUiCss(uiPath))
